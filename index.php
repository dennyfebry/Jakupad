		...
		<header class="masthead">
			<div class="container d-flex h-100 align-items-center">
				<div class="mx-auto text-center">
					<h1 class="mx-auto my-0 text-uppercase">JAKUPAD</h1>
					<h2 class="text-white-50 mx-auto mt-2 mb-5">JAKUPAD adalah aplikasi Jalur Evakuasi di Unpad, fungsi utamanya adalah untuk memberi saran ketika ada musibah yang kita duga, dan pastinya setiap orang ini pergi ke tempat aman, dan aplikasi ini membantu civitas unpad dan sekitarnya jika sedang berada di lingkungan Unpad dimanakah jalur tercepat untuk keluar dari Unpad.</h2>
